...
// 数量选择
// var countShow = document.querySelector(".count-choose>input");
// var plusBtn = document.querySelector(".count-choose>button.plus");
// var minusBtn = document.querySelector(".count-choose>button.minus");
// var countNum = parseInt(countShow.value);
